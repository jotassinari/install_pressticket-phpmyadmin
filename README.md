...
```bash
sudo apt install -y git && git clone https://github.com/jotassinari/install_pressticket-phpmyadmin.git instalador && sudo chmod -R 777 ./instalador && cd ./instalador && sudo ./install_primaria
```
